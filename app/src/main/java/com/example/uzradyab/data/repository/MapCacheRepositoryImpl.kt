...
import com.example.uzradyab.map.offline.MapboxOfflineRegionManager
...
class MapCacheRepositoryImpl @Inject constructor(
    ...
    private val offlineRegionManager: MapboxOfflineRegionManager,
) : MapCacheRepository {
    ...
    override suspend fun clearOfflineRegions(): Result<Unit> = runCatching {
        offlineRegionManager.clearOfflineMapData().getOrThrow()
